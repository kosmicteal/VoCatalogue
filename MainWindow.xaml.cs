...
namespace VoCatalogue
{
    ...
    public static class ProductData
    {
        ...
        private static List<VoiceBank> digitalBoxes = new List<VoiceBank>()
        {
            ...
            new VoiceBank(){Reference="Bruno", Profile="img/profile/v3/bruno.jpg", Website="https://www.voctro-vocaloid.com/brunoclara", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="Clara", Profile="img/profile/v3/clara.jpg", Website="https://www.voctro-vocaloid.com/brunoclara", Category=CategoryType.VOCALOID},
            ...
            new VoiceBank(){Reference="結月ゆかり [V4 Onn]", Profile="img/profile/v4/yukari_onn.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="結月ゆかり [V4 Lin]", Profile="img/profile/v4/yukari_lin.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="巡音ルカ [V4x]", Profile="img/profile/v4/luka.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="がくっぽいど [V4 Native]", Profile="img/profile/v4/gackpoid_native.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="がくっぽいど [V4 Whisper]", Profile="img/profile/v4/gackpoid_whisper.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="がくっぽいど [V4 Power]", Profile="img/profile/v4/gackpoid_power.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="SF-A2 miki [V4]", Profile="img/profile/v4/sfa2miki.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="猫村いろは [V4 Natural]", Profile="img/profile/v4/iroha_natural.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="猫村いろは [V4 Soft]", Profile="img/profile/v4/iroha_soft.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="v4 flower", Profile="img/profile/v4/vflower.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="Sachiko", Profile="img/profile/v4/sachiko.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="ARSLOID", Profile="img/profile/v4/arsloid.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="RUBY", Profile="img/profile/v4/ruby.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="歌愛ユキ [V4]", Profile="img/profile/v4/yuki.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="氷山キヨテル [V4 Natural]", Profile="img/profile/v4/kiyoteru_natural.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="氷山キヨテル [V4 Rock]", Profile="img/profile/v4/kiyoteru_rock.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="GUMI [V4 Native]", Profile="img/profile/v4/gumi_native.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="GUMI [V4 Adult]", Profile="img/profile/v4/gumi_adult.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="GUMI [V4 Power]", Profile="img/profile/v4/gumi_power.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="GUMI [V4 Sweet]", Profile="img/profile/v4/gumi_sweet.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="GUMI [V4 Whisper]", Profile="img/profile/v4/gumi_whisper.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="DEX", Profile="img/profile/v4/dex.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="DAINA", Profile="img/profile/v4/daina.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="Rana [V4]", Profile="img/profile/v4/rana.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="鏡音リン・レン [V4x]", Profile="img/profile/v4/rinlen_v4x.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="鏡音リン・レン [V4 English]", Profile="img/profile/v4/rinlen_v4e.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="Unity-chan", Profile="img/profile/v4/unitychan.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="Fukase", Profile="img/profile/v4/fukase.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="星尘 [V4]", Profile="img/profile/v4/stardust.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="音街ウナ [V4]", Profile="img/profile/v4/una.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="初音ミク [V4x]", Profile="img/profile/v4/miku_v4x.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="初音ミク [V4 English]", Profile="img/profile/v4/miku_v4e.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="東北ずん子 [V4]", Profile="img/profile/v4/zunko.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="CYBER SONGMAN", Profile="img/profile/v4/cybersongman.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="マクネナナ [V4 Natural]", Profile="img/profile/v4/nana_natural.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="マクネナナ [V4 Petit]", Profile="img/profile/v4/nana_petit.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="マクネナナ [V4 English]", Profile="img/profile/v4/nana_english.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="UNI", Profile="img/profile/v4/uni.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="兎眠りおん [V4]", Profile="img/profile/v4/rion.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="夢眠ネム", Profile="img/profile/v4/nemu.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="乐正龙牙", Profile="img/profile/v4/ling.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="AZUKI", Profile="img/profile/v4/azuki.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="MATCHA", Profile="img/profile/v4/matcha.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="LUMi", Profile="img/profile/v4/lumi.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="心華 [V4]", Profile="img/profile/v4/xinhua_chn.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="心華 [V4 JPN]", Profile="img/profile/v4/xinhua_jpn.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="洛天依 [V4 CHN]", Profile="img/profile/v4/luo_chn.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="洛天依 [V4 JPN]", Profile="img/profile/v4/luo_jpn.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="紲星あかり [V4]", Profile="img/profile/v4/akari.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
            new VoiceBank(){Reference="ミライ小町", Profile="img/profile/v4/mirai.jpg", Website="https://powerfx.com/products/sweet-ann", Category=CategoryType.VOCALOID},
